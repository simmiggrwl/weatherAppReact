...
function getEntry(cosmosConfig) {
  var _createWebpackCosmosC = (0, _webpack.createWebpackCosmosConfig)(cosmosConfig),
      hotReload = _createWebpackCosmosC.hotReload,
      reloadOnFail = _createWebpackCosmosC.reloadOnFail; // The React devtools hook needs to be imported before any other module that
  // might import React
...
function getHotMiddlewareEntry(reloadOnFail) {
  ...
  return "".concat(clientPath, "?reload=").concat(reloadOnFail, "&overlay=false");
}